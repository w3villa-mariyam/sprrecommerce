...
class StoresTest < ApplicationSystemTestCase
  ...
  test "creating a Store" do
    ...
    fill_in "Currency", with: @store.currency
    fill_in "Meta discription", with: @store.meta_discription
    fill_in "Meta keyword", with: @store.meta_keyword
    fill_in "Name", with: @store.name
    fill_in "Seo title", with: @store.seo_title
