...
class TaxonomiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create taxonomy" do
    assert_difference('Taxonomy.count') do
      post taxonomies_url, params: { taxonomy: { category_id: @taxonomy.category_id, name: @taxonomy.name, taxon_id: @taxonomy.taxon_id } }
    end
  ...
  test "should update taxonomy" do
    patch taxonomy_url(@taxonomy), params: { taxonomy: { category_id: @taxonomy.category_id, name: @taxonomy.name, taxon_id: @taxonomy.taxon_id } }
