...
class ZonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create zone" do
    assert_difference('Zone.count') do
      post zones_url, params: { zone: { discription: @zone.discription, name: @zone.name, state_id: @zone.state_id } }
    end
  ...
  test "should update zone" do
    patch zone_url(@zone), params: { zone: { discription: @zone.discription, name: @zone.name, state_id: @zone.state_id } }
