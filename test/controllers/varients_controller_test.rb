...
class VarientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create varient" do
    assert_difference('Varient.count') do
      post varients_url, params: { varient: { cost_price: @varient.cost_price, depth: @varient.depth, height: @varient.height, name: @varient.name, price: @varient.price, sku: @varient.sku, weight: @varient.weight, width: @varient.width } }
    end
  ...
  test "should update varient" do
    patch varient_url(@varient), params: { varient: { cost_price: @varient.cost_price, depth: @varient.depth, height: @varient.height, name: @varient.name, price: @varient.price, sku: @varient.sku, weight: @varient.weight, width: @varient.width } }
