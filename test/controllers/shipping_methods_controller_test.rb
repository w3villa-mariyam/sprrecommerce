...
class ShippingMethodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shipping_method" do
    assert_difference('ShippingMethod.count') do
      post shipping_methods_url, params: { shipping_method: { name: @shipping_method.name, shipping_category_id: @shipping_method.shipping_category_id, tax_category_id: @shipping_method.tax_category_id, zone_id: @shipping_method.zone_id } }
    end
  ...
  test "should update shipping_method" do
    patch shipping_method_url(@shipping_method), params: { shipping_method: { name: @shipping_method.name, shipping_category_id: @shipping_method.shipping_category_id, tax_category_id: @shipping_method.tax_category_id, zone_id: @shipping_method.zone_id } }
