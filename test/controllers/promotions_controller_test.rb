...
class PromotionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post promotions_url, params: { promotion: { category_id: @promotion.category_id, code: @promotion.code, discription: @promotion.discription, name: @promotion.name } }
    end
  ...
  test "should update promotion" do
    patch promotion_url(@promotion), params: { promotion: { category_id: @promotion.category_id, code: @promotion.code, discription: @promotion.discription, name: @promotion.name } }
